namespace CinemaManagement_Project.Pay
{
    partial class EditTrailer
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(EditTrailer));
            tbx_Synopsis = new TextBox();
            tbx_ReleaseDate = new TextBox();
            tbx_Actors = new TextBox();
            tbx_Director = new TextBox();
            tbx_SubtitleOrDubbing = new TextBox();
            tbx_Country = new TextBox();
            tbx_Duration = new TextBox();
            ...
            tbx_SubtitleOrDubbing.TabIndex = 63;
            // 
            // tbx_Country
            // 
            ...
            axWindowsMediaPlayer1.TabIndex = 58;
            // 
            // label7
            // 
            ...
            Controls.Add(tbx_ReleaseDate);
            Controls.Add(tbx_Actors);
            Controls.Add(tbx_Director);
            Controls.Add(tbx_SubtitleOrDubbing);
            Controls.Add(tbx_Country);
            Controls.Add(tbx_Duration);
        ...
        private TextBox tbx_Synopsis;
        private TextBox tbx_ReleaseDate;
        private TextBox tbx_Actors;
        private TextBox tbx_Director;
        private TextBox tbx_SubtitleOrDubbing;
        private TextBox tbx_Country;
        private TextBox tbx_Duration;
